...
if __name__ == '__main__':
    ...
    videoname = os.path.join( '{0:0>2}.mp4'.format('386'))
    videowrite = cv2.VideoWriter(videoname, fourcc, 30, (512,512))
    for filename in sorted(glob.glob('data/pose_sequence/aninerf_386/view0000/*.png')):
        #print(filename)
